...
import {getSingleShirt, shirtsByCategory, getAllCatagories} from '../../store/actions/shirtsActions.js'
...
export default connect(mapStateToProps, {getSingleShirt, shirtsByCategory, getAllCatagories})(Shirts);
